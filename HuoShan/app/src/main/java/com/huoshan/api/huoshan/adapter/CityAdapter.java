...
public class CityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    private List<CityBean.DataBeanX> list;
    ...
    public CityAdapter(List<CityBean.DataBeanX> list , Context context, boolean hasMore) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            View view =inflater.inflate(R.layout.city_adapter_item, null);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            CityAdapter.MyViewHolder myViewHolder = (CityAdapter.MyViewHolder) holder;
            CityBean.DataBeanX dataBeanX = list.get(position);
    ...
    public void updateList(List<CityBean.DataBeanX> newDatas, boolean hasMore) {
        // 在原有的数据之上增加新数据
        if (newDatas != null) {
